...
public class TopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setRecyclerView();
        createMyRank("10", ProfileDrawable[1], userName, "612,709");
        createRankOne();
        createList();
        return v;
    }
    ...
    private void createList(){
       ...
       /* rankingModels.add(new RankingModel("2", ProfileDrawable[1], "나이스러너", "3,566,851"));
        ...
        rankingModels.add(new RankingModel("13", ProfileDrawab                                  le[2], "User34", "325,331"));
    ...
    private void createRankOne() {
        ...
        rankOneModels.add(new RankOneModel(ProfileDrawable[0],"Hansung1998", 52114852));
