...
public class PedoRankingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<PedoRankingModel> rankList;
    private ArrayList<PedoRankOneModel> rank1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEADER) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ranking_pedo_rankone_header, parent, false);
            holder = new HeaderViewHolder(view);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ranking_pedo_item_recylerview, parent, false);
    ...
    public void setRankList(ArrayList<PedoRankingModel> list) {
        this.rankList = list;
        notifyDataSetChanged();
    }

    public void setRank1List(ArrayList<PedoRankOneModel> list) {
        this.rank1 = list;
        notifyDataSetChanged();
    }
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(PedoRankOneModel rank1Model) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(PedoRankingModel rankingModel) {
