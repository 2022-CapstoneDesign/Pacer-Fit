...
public class OneWeekDist extends Fragment {

    private LineChart lineChart; // 만보기 7일 막대그래프
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_one_week_dist, container, false);
    ...
    private List<DistRecordModel> getList() {
        ...
        record_list.add(new DistRecordModel("목", "오후 6:21 - 오후 7:02", "40분", "8km"));
        record_list.add(new DistRecordModel("수", "오전 7:04 - 오후 9:37", "2시간 33분", "31km"));
        record_list.add(new DistRecordModel("화", "오후 6:22 - 오후 10:29", "4시간 7분", "58km"));
        record_list.add(new DistRecordModel("월", "오전 10:14 - 오후 11:36", "1시간 22분", "13km"));
        record_list.add(new DistRecordModel("일", "오후 9:33 - 오후 10:14", "41분", "8.5km"));
        record_list.add(new DistRecordModel("토", "오후 3:47 - 오후 5:55", "2시간 8분", "12.8km"));
